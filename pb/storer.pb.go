...
var file_pb_storer_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x01, 0x54, 0x12, 0x0c, 0x0a, 0x01, 0x4e, 0x18, 0x03,
	...
	0x6c, 0x64, 0x32, 0x9d, 0x09, 0x0a, 0x06, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x72, 0x12, 0x28, 0x0a,
	...
	0x74, 0x54, 0x79, 0x70, 0x65, 0x1a, 0x08, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x55, 0x49, 0x44, 0x22,
	...
	0x6f, 0x64, 0x65, 0x64, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x29,
...
var file_pb_storer_proto_depIdxs = []int32{
	...
	31, // 36: pb.Storer.SetReference:input_type -> pb.Reference
	33, // 37: pb.Storer.CheckAndSetReference:input_type -> pb.SetReferenceParams
	21, // 38: pb.Storer.GetReference:input_type -> pb.ReferenceName
	6,  // 39: pb.Storer.GetReferences:input_type -> pb.None
	21, // 40: pb.Storer.RemoveReference:input_type -> pb.ReferenceName
	6,  // 41: pb.Storer.CountLooseRefs:input_type -> pb.None
	6,  // 42: pb.Storer.PackRefs:input_type -> pb.None
	30, // 43: pb.Storer.SetShallow:input_type -> pb.Hashs
	6,  // 44: pb.Storer.Shallow:input_type -> pb.None
	22, // 45: pb.Storer.SetIndex:input_type -> pb.Index
	6,  // 46: pb.Storer.GetIndex:input_type -> pb.None
	6,  // 47: pb.Storer.GetConfig:input_type -> pb.None
	13, // 48: pb.Storer.SetConfig:input_type -> pb.Config
	6,  // 49: pb.Storer.Modules:input_type -> pb.None
	4,  // 50: pb.Storer.NewEncodedObject:output_type -> pb.UUID
	10, // 51: pb.Storer.SetEncodedObject:output_type -> pb.Hash
	6,  // 52: pb.Storer.SetEncodedObjectType:output_type -> pb.None
	6,  // 53: pb.Storer.SetEncodedObjectSetSize:output_type -> pb.None
	2,  // 54: pb.Storer.EncodedObjectEntity:output_type -> pb.EncodedObject
	7,  // 55: pb.Storer.EncodedObjectType:output_type -> pb.Int
	10, // 56: pb.Storer.EncodedObjectHash:output_type -> pb.Hash
	8,  // 57: pb.Storer.EncodedObjectSize:output_type -> pb.Int64
	5,  // 58: pb.Storer.EncodedObjectRWStream:output_type -> pb.RWStream
	4,  // 59: pb.Storer.NewEncodedObjectIter:output_type -> pb.UUID
	2,  // 60: pb.Storer.EncodedObjectNext:output_type -> pb.EncodedObject
	2,  // 61: pb.Storer.EncodedObjectForEach:output_type -> pb.EncodedObject
	6,  // 62: pb.Storer.SetReference:output_type -> pb.None
	6,  // 63: pb.Storer.CheckAndSetReference:output_type -> pb.None
	31, // 64: pb.Storer.GetReference:output_type -> pb.Reference
	32, // 65: pb.Storer.GetReferences:output_type -> pb.References
	6,  // 66: pb.Storer.RemoveReference:output_type -> pb.None
	8,  // 67: pb.Storer.CountLooseRefs:output_type -> pb.Int64
	6,  // 68: pb.Storer.PackRefs:output_type -> pb.None
	6,  // 69: pb.Storer.SetShallow:output_type -> pb.None
	30, // 70: pb.Storer.Shallow:output_type -> pb.Hashs
	6,  // 71: pb.Storer.SetIndex:output_type -> pb.None
	22, // 72: pb.Storer.GetIndex:output_type -> pb.Index
	13, // 73: pb.Storer.GetConfig:output_type -> pb.Config
	6,  // 74: pb.Storer.SetConfig:output_type -> pb.None
	11, // 75: pb.Storer.Modules:output_type -> pb.ModuleNames
